                    ...
                    <tbody>
                        <?php
                            ...
                            while($row=mysqli_fetch_assoc($resultado)) {
                                ...
                                echo "<td>".$row["logo"]."</td>";
                                echo "<td>";
                                echo "<a href='../marcas/eliminar.php?id_enviado=".$row["id"]."'> <button class='btn btn-sm'>Eliminar</button></a>";
                                echo "</td>";

                                echo "<td>";
                                echo "<a href='../marcas/editar.php?id_enviado=".$row["id"]."'> <button class='btn btn-sm'>Editar</button></a>";
                                echo "</td>";
                                echo "</tr>";
                            }
                        ?>
